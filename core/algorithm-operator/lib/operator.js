...
class Operator {
    ...
    async _interval(options) {
        ...
        try {
            ...
            await Promise.all([
                this._algorithmBuilds({
                    ...configMap,
                    resourcesMain: options.resources.algorithmBuilderMain,
                    resourcesBuilder: options.resources.algorithmBuilderBuilder,
                    algorithmBuilderResourcesEnable: options.resources.algorithmBuilderResourcesEnable
                }, options),
    ...
    async _algorithmBuilds({ versions, registry, clusterOptions, resourcesMain, resourcesBuilder, algorithmBuilderResourcesEnable }, options) {
        ...
        await algorithmBuildsReconciler.reconcile({
            ...
            resourcesMain,
            resourcesBuilder,
            algorithmBuilderResourcesEnable
        });
    }
