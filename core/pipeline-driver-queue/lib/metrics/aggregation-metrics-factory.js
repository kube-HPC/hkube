...
class AggregationMetricsFactory {
    ...
    _scoreTask(task) {
        try {
            ...
            this._metrics[metricsName.BATCH_SCORE].instance[0].retroactive({labelValues,
                time: task.calculated.latestScores[heuristicsName.BATCH]});
            this._metrics[metricsName.PRIORITY_SCORE].instance[0].retroactive({labelValues,
                time: task.calculated.latestScores[heuristicsName.PRIORITY]});
            this._metrics[metricsName.TIME_SCORE].instance[0].retroactive({labelValues,
                time: task.calculated.score});
            this._metrics[metricsName.TOTAL_SCORE].instance[0].retroactive({labelValues,
