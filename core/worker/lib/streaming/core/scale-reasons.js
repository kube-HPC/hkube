...
const keys = {
    ...
    IDLE_TIME: 'based on no requests and no responses for {minTimeIdleBeforeReplicaDown} sec',
    DUR_RATIO: 'based on durations ratio of {durationsRatio} (min is {minRatioToScaleDown})'
};
