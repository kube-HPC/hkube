...
class Executor {
    ...
    async _intervalCallback() {
        ...
        const versions = this._versions || await kubernetes.getVersionsConfigMap();
        ...
        const newConfig = await reconciler.reconcile({ algorithmRequests, algorithmPods, jobs, versions });
