...
1. **Structural Audit**: Map the Core Logic Loop (e.g., `reconcile()` functions) and State Management.
2. **Logic Extraction**: 
...
3. **Dependency Mapping**: Document Southbound (APIs called) and Northbound (Triggers) interfaces.
